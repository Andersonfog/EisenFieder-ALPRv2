  ...
  return (
    <div className="app-page max-w-4xl space-y-6">
      ...
      <section className="space-y-5 text-sm leading-relaxed">
        <div className="rounded-md bg-amber-400 px-3 py-2 font-semibold text-black">
          Effective Immediately | Strictly Enforced
        </div>

        <div>
          <h2 className="mb-2 font-semibold text-gray-300">1. Acceptance of Terms</h2>
        ...
        <div>
          <h2 className="mb-2 font-semibold text-gray-300">2. System Description</h2>
          <p className="text-gray-400">
        ...
        <div>
          <h2 className="mb-2 font-semibold text-gray-300">3. License and Permitted Use</h2>
        ...
        <div>
          <h2 className="mb-2 font-semibold text-gray-300">4. Data Collection and Privacy</h2>
          <ul className="text-gray-400 space-y-1 list-disc list-inside">
        ...
        <div>
          <h2 className="mb-2 font-semibold text-gray-300">5. User Obligations</h2>
          <ul className="text-gray-400 space-y-1 list-disc list-inside">
        ...
        <div>
          <h2 className="mb-2 font-semibold text-gray-300">6. Prohibited Conduct</h2>
        ...
        <div>
          <h2 className="mb-2 font-semibold text-gray-300">7. Watchlist and Alerts</h2>
          <p className="text-gray-400">
        ...
        <div>
          <h2 className="mb-2 font-semibold text-gray-300">8. Liability and Disclaimer</h2>
          <ul className="text-gray-400 space-y-1 list-disc list-inside">
        ...
        <div>
          <h2 className="mb-2 font-semibold text-gray-300">9. Termination</h2>
          <p className="text-gray-400">
        ...
        <div>
          <h2 className="mb-2 font-semibold text-gray-300">10. Governing Law</h2>
          <p className="text-gray-400">
        ...
        <div>
          <h2 className="mb-2 font-semibold text-gray-300">11. Amendments</h2>
          <p className="text-gray-400">
